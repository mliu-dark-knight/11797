...
# parser.add_argument('--save', type=str, default='../experiment/HOTPOT-20190422-013339')
...
parser.add_argument('--locate_global', default=True, action='store_true', help='Add global layer for locator')
